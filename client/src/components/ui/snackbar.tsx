...
export function Snackbar({ message, type = "success", duration = 3000, onClose }: SnackbarProps) {
  ...
  return (
    <div
      className={cn(
        "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[100] flex items-center justify-center gap-2 rounded-lg border px-4 py-3 shadow-lg backdrop-blur transition-all duration-200 whitespace-nowrap",
        styleMap[type],
